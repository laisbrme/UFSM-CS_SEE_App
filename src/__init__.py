...
class janelas:
    def criaBarraMenus(self, app):
        ...
        submenu1.add_command(label="1.Manobra no Disjuntor", command=CJM.semComando)
        submenu1.add_command(label="2.Manobra na Barra", command=CJM.semComando)
        submenu1.add_command(label="3.Manobra no Transformador de Potência", command=CJM.semComando)
