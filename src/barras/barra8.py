...
def finaliza(elem_sel):
    if elem_sel == 'Trocar D2':
        newImage = PhotoImage(file='img/bar8/bar8D2.png')
        ...
        newImage = PhotoImage(file='img/bar8/bar8D3.png')
        diagrama.configure(image=newImage)
        diagrama.image = newImage
        telaInt.configure(text='--------------------------------------------------------------\n'
        ...
        newImage = PhotoImage(file='img/bar8/bar8D4.png')
        diagrama.configure(image=newImage)
        diagrama.image = newImage
        telaInt.configure(text='--------------------------------------------------------------\n'
        ...
        newImage = PhotoImage(file='img/bar8/bar8D5.png')
        diagrama.configure(image=newImage)
        diagrama.image = newImage
        telaInt.configure(text='--------------------------------------------------------------\n'
        ...
        newImage = PhotoImage(file='img/bar8/bar8D6.png')
        diagrama.configure(image=newImage)
        diagrama.image = newImage
        telaInt.configure(text='--------------------------------------------------------------\n'
        ...
        newImage = PhotoImage(file='img/bar8/bar8D7.png')
        diagrama.configure(image=newImage)
        diagrama.image = newImage
        telaInt.configure(text='--------------------------------------------------------------\n'
