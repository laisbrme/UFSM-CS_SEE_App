...
def inicio():
    ...
    def Disj7Passo1b():
        ...
        if elem_sel == 'Ligar D9':
            ...
            botao1.configure(command=lambda: Disj7Passo2b())
        else:
            telaInt.configure(text='------------------------------------------------------------------------\n'
                                   'Seleção inválida!\n'
                                   'Selecione o próximo passo:\n'
    ...
    def Disj6Passo1b():
        ...
        if elem_sel == 'Ligar D9':
            ...
            botao1.configure(command=lambda: Disj6Passo2b())
        else:
            telaInt.configure(text='------------------------------------------------------------------------\n'
                                   'Seleção inválida!\n'
                                   'Selecione o próximo passo:\n'
    ...
    def Disj5Passo1b():
        ...
        if elem_sel == 'Ligar D9':
            ...
            botao1.configure(command=lambda: Disj5Passo2b())
        else:
            telaInt.configure(text='------------------------------------------------------------------------\n'
                                   'Seleção inválida!\n'
                                   'Selecione o próximo passo:\n'
    ...
    def Disj4Passo1b():
        ...
        if elem_sel == 'Ligar D9':
            ...
            botao1.configure(command=lambda: Disj4Passo2b())
        else:
            telaInt.configure(text='------------------------------------------------------------------------\n'
                                   'Seleção inválida!\n'
                                   'Selecione o próximo passo:\n'
    ...
    def Disj3Passo1b():
        ...
        if elem_sel == 'Ligar D9':
            ...
            botao1.configure(command=lambda: Disj3Passo2b())
        else:
            telaInt.configure(text='------------------------------------------------------------------------\n'
                                   'Seleção inválida!\n'
                                   'Selecione o próximo passo:\n'
