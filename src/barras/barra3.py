...
def inicia():
	...
	def finaliza(elem_sel):
		...
		if elem_sel == 'Trocar D3':
			newImage = PhotoImage(file='img/bar3/bar3D3e.png')
			...
			newImage = PhotoImage(file='img/bar3/bar3D4e.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
			telaInt.configure(text='------------------------------------------------------------------------\n'
			...
			newImage = PhotoImage(file='img/bar3/bar3D5e.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
			telaInt.configure(text='------------------------------------------------------------------------\n'
			...
			newImage = PhotoImage(file='img/bar3/bar3D6e.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
			telaInt.configure(text='------------------------------------------------------------------------\n'
			...
			newImage = PhotoImage(file='img/bar3/bar3D7e.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
			telaInt.configure(text='------------------------------------------------------------------------\n'
		...
		elif elem_sel == 'Trocar D8':
			newImage = PhotoImage(file='img/bar3/bar3D8.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
			telaInt.configure(text='------------------------------------------------------------------------\n'
								   'Manobra em Disjuntor D8 finalizada!\n'
								   '------------------------------------------------------------------------')
	...
	def Disj8Passo2():
		...
		if elem_sel == 'Trocar D8':
			newImage = PhotoImage(file='img/bar3/bar3D8d.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage

			telaInt.configure(
				text='------------------------------------------------------------------------\n'
					 'Disjuntor D8 trocado\n\n'
					 'Selecione o próximo passo:\n'
					 '------------------------------------------------------------------------')
			combo.pack_forget()
			
			botao1.configure(text='Finalizar Manobra', command=lambda: finaliza('Trocar D8'))
		else:
			telaInt.configure(
				text='------------------------------------------------------------------------\n'
					 'Seleção inválida!\n'
	...
	def Disj8Passo1():
		...
		if elem_sel == 'Abrir S17-S18':
			newImage = PhotoImage(file='img/bar3/bar3D8c.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
			...
			botao1.configure(command=lambda: Disj8Passo2())
		else:
			telaInt.configure(text='------------------------------------------------------------------------\n'
								   'Seleção inválida!\n'
								   'Selecione o próximo passo:\n'
	...
	def analiseD8():
		...
		if elem_sel == 'Desligar D8':
			newImage = PhotoImage(file='img/bar3/bar3D8b.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
			...
			botao1.configure(command=lambda: Disj8Passo1())
		else:
			telaInt.configure(text='------------------------------------------------------------------------\n'
								   'Seleção inválida!\n'
								   'Selecione o próximo passo:\n'
	...
	def Disj7Passo2():
		...
		if elem_sel == 'Trocar D7':
			newImage = PhotoImage(file='img/bar3/bar3D7d.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
	...
	def Disj7Passo1():
		...
		if elem_sel == 'Abrir S15-S16':
			newImage = PhotoImage(file='img/bar3/bar3D7c.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
	...
	def analiseD7():
		...
		if elem_sel == 'Desligar D7':
			newImage = PhotoImage(file='img/bar3/bar3D7b.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
	...
	def Disj6Passo2():
		...
		if elem_sel == 'Trocar D6':
			newImage = PhotoImage(file='img/bar3/bar3D6d.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
	...
	def Disj6Passo1():
		...
		if elem_sel == 'Abrir S13-S14':
			newImage = PhotoImage(file='img/bar3/bar3D6c.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
	...
	def analiseD6():
		...
		if elem_sel == 'Desligar D6':
			newImage = PhotoImage(file='img/bar3/bar3D6b.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
	...
	def Disj5Passo2():
		...
		if elem_sel == 'Trocar D5':
			newImage = PhotoImage(file='img/bar3/bar3D5d.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
	...
	def Disj5Passo1():
		...
		if elem_sel == 'Abrir S11-S12':
			newImage = PhotoImage(file='img/bar3/bar3D5c.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
	...
	def analiseD5():
		...
		if elem_sel == 'Desligar D5':
			newImage = PhotoImage(file='img/bar3/bar3D5b.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
	...
	def Disj4Passo2():
		...
		if elem_sel == 'Trocar D4':
			newImage = PhotoImage(file='img/bar3/bar3D4d.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
	...
	def Disj4Passo1():
		...
		if elem_sel == 'Abrir S9-S10':
			newImage = PhotoImage(file='img/bar3/bar3D4c.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
	...
	def analiseD4():
		...
		if elem_sel == 'Desligar D4':
			newImage = PhotoImage(file='img/bar3/bar3D4b.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
	...
	def Disj3Passo2():
		...
		if elem_sel == 'Trocar D3':
			newImage = PhotoImage(file='img/bar3/bar3D3d.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
	...
	def Disj3Passo1():
		...
		if elem_sel == 'Abrir S7-S8':
			newImage = PhotoImage(file='img/bar3/bar3D3c.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
	...
	def analiseD3():
		...
		if elem_sel == 'Desligar D3':
			newImage = PhotoImage(file='img/bar3/bar3D3b.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
	...
	def selectFalha():
		...
		if elem_sel == 'Disjuntor D3':
			newImage = PhotoImage(file='img/bar3/bar3D3a.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
			...
			newImage = PhotoImage(file='img/bar3/bar3D4a.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
			...
			newImage = PhotoImage(file='img/bar3/bar3D5a.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
			...
			newImage = PhotoImage(file='img/bar3/bar3D6a.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage
			...
			newImage = PhotoImage(file='img/bar3/bar3D7a.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage

			botao1.configure(command=lambda: analiseD7())
		
		elif elem_sel == 'Disjuntor D8':
			newImage = PhotoImage(file='img/bar3/bar3D8a.png')
			diagrama.configure(image=newImage)
			diagrama.image = newImage

			botao1.configure(command=lambda: analiseD8())
	...
	# Objeto imagem:
	image = PhotoImage(file='img/bar3/bar3.png')
	...
	telaInt = Label(subcontainer1,
					text='------------------------------------------------------------------------\n'
						 'Barramento Principal com Seccionamento de Barra\n\n'
